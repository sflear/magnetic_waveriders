...
#define DEFAULT_TARGET_VALUE  250       //Default target hall effect readout
#define DEFAULT_KP            0.46      //Default Kp, proportional gain parameter
#define DEFAULT_KD            0.8

#define DEFAULT_KI            0.001     //Default Ki, integral gain parameter
...
#define FILTERFACTOR 2                   //Weighting factor for hall sensor reading. We calculate a running average, with the most recent reading making up 1/FILTERFACTOR of the average. Lower = faster, higher = smoother
